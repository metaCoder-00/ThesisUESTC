...
\begin{figure}[H]
    \subfloat[]{
        \label{ml_azm_rmse}
        \includegraphics[scale=0.285]{pic/ml_azm_rmse.eps}
    }
    \subfloat[]{
        \label{ml_elv_rmse}
        \includegraphics[scale=0.285]{pic/ml_elv_rmse.eps}
    }
...
\begin{figure}[H]
    \subfloat[]{
        \label{mvam_azm_rmse}
        \includegraphics[scale=0.285]{pic/mvam_azm_rmse.eps}
    }
    \subfloat[]{
        \label{mvam_elv_rmse}
        \includegraphics[scale=0.285]{pic/mvam_elv_rmse.eps}
    }
...
\begin{figure}[H]
    \subfloat[]{
        \label{jlc_azm_rmse}
        \includegraphics[scale=0.285]{pic/jlc_azm_rmse.eps}
    }
    \subfloat[]{
        \label{jlc_elv_rmse}
        \includegraphics[scale=0.285]{pic/jlc_elv_rmse.eps}
    }
...
\begin{figure}[H]
    \subfloat[]{
        ...
        \includegraphics[scale=0.285]{pic/svd_jlc_azm_rmse.eps}
    }
    \subfloat[]{
        \label{svd_jlc_elv_rmse}
        \includegraphics[scale=0.285]{pic/svd_jlc_elv_rmse.eps}
    }
...
\begin{figure}[H]
    \subfloat[]{
        ...
        \includegraphics[scale=0.285]{pic/jlc_azm_rmse_slj.eps}
    }
    \subfloat[]{
        \label{svd_jlc_azm_rmse_slj}
        \includegraphics[scale=0.285]{pic/svd_jlc_azm_rmse_slj.eps}
    }
...
\begin{figure}[H]
    \subfloat[]{
        ...
        \includegraphics[scale=0.285]{pic/jlc_elv_rmse_slj.eps}
    }
    \subfloat[]{
        \label{svd_jlc_elv_rmse_slj}
        \includegraphics[scale=0.285]{pic/svd_jlc_elv_rmse_slj.eps}
    }
...
\begin{figure}[H]
    \subfloat[]{
        ...
        \includegraphics[scale=0.285]{pic/gamma_hat_SLJ.eps}
    }
    \subfloat[]{
        \label{Polar_args_RMSE_b_SLJ}
        \includegraphics[scale=0.285]{pic/eta_hat_SLJ.eps}
    }
